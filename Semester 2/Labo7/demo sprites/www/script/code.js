...
const moveSprite = () => {
	...
	//offsetwidth// property returns the vieuwable width of an element
	//(inpixels) including pading, border and scrollbar
	//but not the margin.
	//clientwith property returns the vieuwable width of an element in pixels
